...
| F6 | The sats converter rounds BTC to 5 decimals (1,000 sats): $1 at $60,000 shows 0.00002 BTC next to 1666 sats. | `components/BtcConverter.tsx` `round` | code reading | bug (display only) | open |
